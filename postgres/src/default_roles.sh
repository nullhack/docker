...
POSSTGRES_DB=${POSTGRES_DB:-postgres}
...
-- USERS
CREATE ROLE ${POSTGRES_USER}_vo LOGIN PASSWORD '${POSTGRES_PASSWORD:0:8}' IN ROLE vo;
CREATE ROLE ${POSTGRES_USER}_ro LOGIN PASSWORD '${POSTGRES_PASSWORD:0:16}' IN ROLE ro;
CREATE ROLE ${POSTGRES_USER}_rw LOGIN PASSWORD '${POSTGRES_PASSWORD:0:24}' IN ROLE rw;
CREATE ROLE ${POSTGRES_USER}_rwa LOGIN PASSWORD '${POSTGRES_PASSWORD:0:32}' IN ROLE rwa;
