...
-- USERS
CREATE USER ${POSTGRES_USER:-postgres}_viewonly WITH PASSWORD '${POSTGRES_PASSWORD:0:8}' IN ROLE viewonly;
CREATE USER ${POSTGRES_USER:-postgres}_readonly WITH PASSWORD '${POSTGRES_PASSWORD:0:16}' IN ROLE readonly;
CREATE USER ${POSTGRES_USER:-postgres}_readwrite WITH PASSWORD '${POSTGRES_PASSWORD:0:32}' IN ROLE readwrite;
